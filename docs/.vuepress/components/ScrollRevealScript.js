...
class ScrollRevealProgress {
  constructor(
     ...
     */
    this.callbackOut =
      typeof callbackOut === 'function' ? callbackOut : () => {}
  ...
  check() {
    this.show =
      this.scrollY + this.wrapHeight > this.offsetTop + this.offset &&
      this.scrollY < this.offsetTop + this.targetHeight
