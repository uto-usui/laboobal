...
<script>
  ...
  import FollowMouseTransform from './FollowMouseTransformScript';
  ...
  export default {
    ...
    mounted() {
      this.$nextTick(() => {
        ...
        new FollowMouseTransform(this.$refs.target2, this.$refs.wrap, .5);
      })
    }
  };
</script>
...
<style scoped lang="scss">
  ...
  .target {
    ...
    &.target--sm {
      width: 1.5rem;
      height: 1.5rem;
      background-color: darken(#25ECB7, 15%);
    }
  }
